...
"UOUIN_API": "{Replace with the real API url}"
```
...
| {LINE}      | Line supplier          | China Mobile                         |
...
|--------------|------------------------------------------|
| Method       | GET                                      |
| Description  | Generate xray url list via api.uouin.com |
| Accept       | \*/*                                     |
| Content-Type | text/plain;charset=UTF-8                 |
...
| {LOSS}      | Packet loss rate     | 0%                                   |
| {LATENCY}   | Latency              | 160ms                                |
| {SPEED}     | Download speed       | 34mb/s                               |
| {BANDWIDTH} | Bandwidth            | 272mb                                |

#### Example

```text
https://example.workers.dev/ApiUouinCom?lang=ZH&remark=%7BNAME%7D%20-%20%7BLINE%7D%20-%20%7BLATENCY%7D%20-%20%7BBANDWIDTH%7D%20-%20%7BLOSS%7D%20-%20%7BTIME%7D&name=Xray&protocol=vless&uuid=63fd1162-132e-4ce0-bd77-b58d7712a876&encryption=none&security=tls&sni=example.com&alpn=http%2F1.1&type=ws&host=example.com&path=%2F%3Fed%3D2048
```
